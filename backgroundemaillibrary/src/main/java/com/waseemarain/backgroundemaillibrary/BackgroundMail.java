package com.waseemarain.backgroundemaillibrary;
...
import com.waseemarain.backgroundemaillibrary.util.GmailSender;
import com.waseemarain.backgroundemaillibrary.util.Utils;
...
public class BackgroundMail {
    ...
    public void send() {
        ...
        if (TextUtils.isEmpty(mailto)) {
            throw new IllegalArgumentException("You didn't set a Gmail recipient To");
        }
        if (TextUtils.isEmpty(mailCc)) {
            throw new IllegalArgumentException("You didn't set a Gmail recipient Cc");
        }
        if (TextUtils.isEmpty(mailBcc)) {
            throw new IllegalArgumentException("You didn't set a Gmail recipient Bcc");
        }
